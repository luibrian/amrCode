function obstacleVerts = plotMap8(mapEight, mapLimits, figHdl)
...
% Draw the boundary
line([vxMin vxMax],[vyMin vyMin],'LineWidth',1,'Color',[0 0 0])
line([vxMax vxMax],[vyMin vyMax],'LineWidth',1,'Color',[0 0 0])
line([vxMax vxMin],[vyMax vyMax],'LineWidth',1,'Color',[0 0 0])
line([vxMin vxMin],[vyMax vyMin],'LineWidth',1,'Color',[0 0 0])

% Configure the axes
axis([vxMin-1 vxMax+1 vyMin-1 vyMax+1])
axis equal
